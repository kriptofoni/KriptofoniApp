...
export class AppComponent {
  ...
  constructor(
    ...
    this.pages = [
      ...
      { title: '1 Saatin Yükselenleri', component: "", icon: "trending-up-outline", url: "https://www.kriptofoni.com/1-saatte-en-cok-yukselen-coinler/" },
      { title: '24 Saatin Yükselenleri', component: "", icon: "trending-up-outline", url: "https://www.kriptofoni.com/24-saatte-en-cok-yukselen-coinler/" },
      { title: '1 Haftanın Yükselenleri', component: "", icon: "trending-up-outline", url: "https://www.kriptofoni.com/1-haftada-en-cok-yukselen-coinler/" },
      { title: '1 Ayın Yükselenleri', component: "", icon: "trending-up-outline", url: "https://www.kriptofoni.com/1-ayda-en-cok-yukselen-coinler/" },
      { title: '1 Saatin Düşenleri', component: "", icon: "trending-down-outline", url: "https://www.kriptofoni.com/1-saatte-en-cok-dusen-coinler/" },
      { title: '24 Saatin Düşenleri', component: "", icon: "trending-down-outline", url: "https://www.kriptofoni.com/24-saatte-en-cok-dusen-coinler/" },
      { title: '1 Haftanın Düşenleri', component: "", icon: "trending-down-outline", url: "https://www.kriptofoni.com/1-haftada-en-cok-dusen-coinler/" },
      { title: '1 Ayın Düşenleri', component: "", icon: "trending-down-outline", url: "https://www.kriptofoni.com/1-ayda-en-cok-dusen-coinler/" },
